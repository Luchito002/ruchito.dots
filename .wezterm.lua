...
config.background = {
  {
    source = {
      ...
      File = {
        path = "C:/Users/luis/Desktop/ターミナル壁紙/japaneseHouse.png",
        speed = 0.2
      }
    },
    ...
    hsb = {
      brightness = 0.03, -- Set the brightness of the background image (low value to darken the image)
...
config.keys = {
  ...
  { key = 'F12', mods = '', action = wezterm.action.ShowDebugOverlay },
}
